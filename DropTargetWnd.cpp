// DropTargetWnd.cpp (Ripped from MFC sources)
//
...
IMPLEMENT_DYNCREATE(CDropTargetWnd, CWnd)

/////////////////////////////////////////////////////////////////////////////
// CDropTargetWnd

CDropTargetWnd::CDropTargetWnd()
{
...
BEGIN_MESSAGE_MAP(CDropTargetWnd, CWnd)
    //{{AFX_MSG_MAP(CDropTargetWnd)
    ON_WM_DESTROY()
    //}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDropTargetWnd message handlers


BOOL CDropTargetWnd::Register()
{
    ASSERT_VALID(this);
    ASSERT(m_bRegistered == FALSE);
...
DROPEFFECT CDropTargetWnd::OnDragScroll(DWORD dwKeyState, CPoint point)
{
...
/////////////////////////////////////////////////////////////////////////////
// CDropTargetWnd drop/ drop query handling

DROPEFFECT CDropTargetWnd::OnDragEnter(COleDataObject* pDataObject, DWORD dwKeyState, CPoint point)
{
...
DROPEFFECT CDropTargetWnd::OnDragOver(COleDataObject* pDataObject, DWORD dwKeyState, CPoint point)
{
    UNUSED_ALWAYS(pDataObject);
    UNUSED_ALWAYS(dwKeyState);
    UNUSED_ALWAYS(point);
...
BOOL CDropTargetWnd::OnDrop(COleDataObject* pDataObject, DROPEFFECT dropEffect, CPoint point)
{
    UNUSED_ALWAYS(pDataObject);
...
DROPEFFECT CDropTargetWnd::OnDropEx(COleDataObject* pDataObject,
...
void CDropTargetWnd::OnDragLeave()
{
    ASSERT_VALID(this);
    return;
}
...
/////////////////////////////////////////////////////////////////////////////
// CDropTargetWnd::CDropTargetWnd implementation

BEGIN_INTERFACE_MAP(CDropTargetWnd, CWnd)
    INTERFACE_PART(CDropTargetWnd, IID_IDropTarget, DropTarget)
END_INTERFACE_MAP()

STDMETHODIMP_(ULONG) CDropTargetWnd::XDropTarget::AddRef()
{
    METHOD_PROLOGUE_EX_(CDropTargetWnd, DropTarget)
    return pThis->ExternalAddRef();
}

STDMETHODIMP_(ULONG) CDropTargetWnd::XDropTarget::Release()
{
    METHOD_PROLOGUE_EX_(CDropTargetWnd, DropTarget)
    return pThis->ExternalRelease();
}

STDMETHODIMP CDropTargetWnd::XDropTarget::QueryInterface(
...
STDMETHODIMP CDropTargetWnd::XDropTarget::DragEnter(THIS_ LPDATAOBJECT lpDataObject,
    DWORD dwKeyState, POINTL pt, LPDWORD pdwEffect)
{
    METHOD_PROLOGUE_EX(CDropTargetWnd, DropTarget)
    ASSERT_VALID(pThis);
...
STDMETHODIMP CDropTargetWnd::XDropTarget::DragOver(THIS_ DWORD dwKeyState,
...
STDMETHODIMP CDropTargetWnd::XDropTarget::DragLeave(THIS)
{
    METHOD_PROLOGUE_EX(CDropTargetWnd, DropTarget)
    ASSERT_VALID(pThis);
...
STDMETHODIMP CDropTargetWnd::XDropTarget::Drop(THIS_ LPDATAOBJECT lpDataObject,
    DWORD dwKeyState, POINTL pt, LPDWORD pdwEffect)
{
    METHOD_PROLOGUE_EX(CDropTargetWnd, DropTarget)
    ASSERT_VALID(pThis);
